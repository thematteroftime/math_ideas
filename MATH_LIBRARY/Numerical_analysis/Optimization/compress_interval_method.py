...
from MATH_LIBRARY.Numerical_analysis.Optimization.Fibonacci import produce_p
...
def compress_interval_method(tol, a1, b1, fun, method="gold", prec=6, e=0.1,output='table'):
    n = 1
    a1_arr = [a1]
    b1_arr = [b1]
...
a, b, data = compress_interval_method(0.01, 0, 2, function, method="Fibon", e=-0.05,output='table')
