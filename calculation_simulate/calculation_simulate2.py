...
class Calculator(object):
    ...
    def create_text(self, text_list_1D=default_text_1D, c=5, r=6):
        return text_list_1D

    def create_command(self, text_list=default_command_text, number_list=default_number_list, c=5, r=6):
        output_list = []
        for i in range(c * r):
            output_list.append(self.get_command(text_list[i], number_list[i]))
    ...
    def operate(self, single_width=75, single_height=70, screen_height=200, c=5, r=6):
        ...
        self.draw_the_button(c=c, r=r, font=my_font2, bg=btn_bg, fg=btn_fg, bd=0,
