...
class Calculator(object):
    ...
    def main(self):
        ...
        x = tkinter.Button(self.root, text='=', bg='#982425', font=my_font, fg=num_fg, bd=0,
                                 command=lambda: self.press_equal())
        x.place(x=btn_w * 3, y=200 + btn_h * 4, width=btn_w, height=btn_h)
        self.root.mainloop()
